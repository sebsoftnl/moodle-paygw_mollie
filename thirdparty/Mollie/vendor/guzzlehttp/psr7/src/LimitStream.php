 ...
 */
class LimitStream implements \_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
