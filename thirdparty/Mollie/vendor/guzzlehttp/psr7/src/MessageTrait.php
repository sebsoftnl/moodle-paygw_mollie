...
trait MessageTrait
{
    ...
    {
        if (!$this->stream) {
            $this->stream = \_PhpScoper3234cdc49fbb\GuzzleHttp\Psr7\Utils::streamFor('');
        }
        return $this->stream;
    }
    public function withBody(\_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface $body)
    {
        if ($body === $this->stream) {
            return $this;
        }
