 ...
 */
class FnStream implements \_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
