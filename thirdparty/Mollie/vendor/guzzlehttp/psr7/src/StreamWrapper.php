...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface $stream)
    {
