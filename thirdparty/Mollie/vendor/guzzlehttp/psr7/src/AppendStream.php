 ...
 */
class AppendStream implements \_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoper3234cdc49fbb\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \_PhpScoper3234cdc49fbb\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
