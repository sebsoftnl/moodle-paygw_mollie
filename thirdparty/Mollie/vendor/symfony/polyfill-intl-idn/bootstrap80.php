 ...
 */
use _PhpScoper3234cdc49fbb\Symfony\Polyfill\Intl\Idn as p;
...
if (!\function_exists('idn_to_ascii')) {
    ...
    {
        return \_PhpScoper3234cdc49fbb\Symfony\Polyfill\Intl\Idn\Idn::idn_to_ascii($domain, $flags, $variant, $idna_info);
    }
}
if (!\function_exists('idn_to_utf8')) {
    function idn_to_utf8(string $domain, int $flags = 0, int $variant = \INTL_IDNA_VARIANT_UTS46, &$idna_info = null) : string|false
    {
        return \_PhpScoper3234cdc49fbb\Symfony\Polyfill\Intl\Idn\Idn::idn_to_utf8($domain, $flags, $variant, $idna_info);
    }
}
